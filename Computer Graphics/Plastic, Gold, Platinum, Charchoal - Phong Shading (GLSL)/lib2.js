...
function gl_init(gl, vertexShader, fragmentShader) {
   ...
   gl.uSphere   = gl.getUniformLocation(program, "uSphere"  );
   ...
   gl.uPow      = gl.getUniformLocation(program, "uPow"     );
...
function gl_update(gl) {
   ...
   gl.uniform4fv(gl.uSphere  , sphere);
   gl.uniform3fv(gl.uAmbient , ambient);
   gl.uniform3fv(gl.uDiffuse , diffuse);
   gl.uniform3fv(gl.uSpecular, specular);
   gl.uniform1fv(gl.uPow     , power);
   gl.uniform3fv(gl.uLColor  , lColor);
